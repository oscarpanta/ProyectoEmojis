...
public class emoji19 extends AppCompatActivity {
   ...
   private ImageView lt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji19);
      ...
      //  nose2.start(this, R.raw.pajaro3);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji19.this, emoji20.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji19.this, emoji20.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji19.this, emoji18.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
