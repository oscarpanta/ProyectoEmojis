...
public class emoji2 extends AppCompatActivity {
   ...
   // nose2 ns=new nose2();
      ...
      //  nose2.start(this, R.raw.pajaros2);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji2.this, emoji3.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji2.this, emoji3.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji2.this, Emoji1.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
       // nose3.pause();
