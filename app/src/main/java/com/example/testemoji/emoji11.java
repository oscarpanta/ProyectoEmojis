...
public class emoji11 extends AppCompatActivity {
   ...
   // nose2 ns=new nose2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji11);
     ...
     //   nose2.start(this, R.raw.ninarisa);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji11.this, emoji12.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji11.this, emoji12.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji11.this, emoji10.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
