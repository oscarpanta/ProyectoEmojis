...
public class emoji3 extends AppCompatActivity {
      ...
      //  nose2.start(this, R.raw.ninoriendosuave);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji3.this, emoji4.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji3.this, emoji4.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji3.this, emoji2.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
