...
public class emoji4 extends AppCompatActivity {
   ...
   // nose2 ns=new nose2();
       ...
       // nose2.start(this, R.raw.ninarisa);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji4.this, emoji5.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji4.this, emoji5.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji4.this, emoji3.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
