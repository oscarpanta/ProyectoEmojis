...
// playing some other music, pause it and change
        ...
        if (mp != null) {
            ...
            if (perro == 1) {
                mp = MediaPlayer.create(context, R.raw.familia); //Ur BackGround Music
            }
            else if(perro==2){
             //   mp = MediaPlayer.create(context, R.raw.ave);
            }
            else if(perro==3){
                mp = MediaPlayer.create(context, R.raw.oficina);
            }
            else{
                mp = MediaPlayer.create(context, R.raw.unversidad);
            }
