...
public class emoji6 extends AppCompatActivity {
   ...
   // nose2 ns=new nose2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji6);
       ...
       // nose2.start(this, R.raw.ninosescuela);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji6.this, emoji7.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji6.this, emoji7.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji6.this, emoji5.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
