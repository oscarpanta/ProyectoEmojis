...
public class emoji15 extends AppCompatActivity {
   ...
   // private GifImageView lt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji15);
     ...
     //   ns.setvalor(20);
     //   nose2.start(this, R.raw.pajaros2);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji15.this, emoji16.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji15.this, emoji16.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji15.this, emoji14.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
