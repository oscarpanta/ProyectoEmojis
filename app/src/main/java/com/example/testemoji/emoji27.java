...
public class emoji27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji27);
       ...
       // ns.setvalor(17);
       // nose2.start(this, R.raw.ninosriendo2);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji27.this, emoji28.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji27.this, emoji28.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji27.this, emoji26.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
