...
public class emoji28 extends AppCompatActivity {
   ...
   // nose2 ns=new nose2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji28);
       ...
       // nose2.start(this, R.raw.toys);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji28.this, emoji29.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji28.this, emoji29.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji28.this, emoji27.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
