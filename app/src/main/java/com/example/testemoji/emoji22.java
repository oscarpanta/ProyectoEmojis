...
public class emoji22 extends AppCompatActivity {
   ...
   // private GifImageView lt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emoji22);
      ...
      //  ns.setvalor(12);
       // nose2.start(this, R.raw.ninosriendo3);
        ...
        countDownTime = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(emoji22.this, emoji23.class);
    ...
    public  void acepta(View view){
        ...
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji22.this, emoji23.class);
        //shouldPlay = true;
    ...
    public void atras(View view){
        ...
        Context context = view.getContext();
        countDownTime.cancel();
        Intent intent2 = new Intent(emoji22.this, emoji21.class);
        //shouldPlay = true;
        startActivity(intent2);
        finish();
